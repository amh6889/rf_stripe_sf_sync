...
class SubscriptionMapper:
    ...
    def __init__(self, stripe_subscription: StripeSubscriptionService, salesforce_subscription: SalesforceSubscriptionService,
    ...
    def map_active_subscription(self, **event_data):
    ...
    def map_canceled_subscription(self, **event_data):
        try:
            data = event_data['data']['object']
            mapped_status, closed_reason = map_status(data)
            subscription_id = data.get('id')
