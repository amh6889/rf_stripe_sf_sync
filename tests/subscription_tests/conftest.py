...
def canceled_subscription_dict():
    return {
        ...
        "data":
            {
                "object": {
                    "id": "sub_1S6b0tL1MLd6bigCouZed1Md",
                    "object": "subscription",
                    ...
                    "billing_cycle_anchor": 1757699039,
                    "billing_cycle_anchor_config": None,
                    "billing_mode": {
                        "flexible": None,
                        "type": "classic"
                    ...
                    "created": 1757699039,
                    "currency": "usd",
                    "current_period_end": 1765561439,
                    "current_period_start": 1762969439,
                    "customer": "cus_T2gN4rCTxBdqCD",
                    "days_until_due": None,
                    "default_payment_method": "pm_1S6b0rL1MLd6bigCU0bhuz3d",
                    "default_source": None,
                    "default_tax_rates": [],
                    "description": None,
                    "discount": None,
                        ...
                        "data": [
                            {
                                ...
                                "quantity": 30,
                                "subscription": "sub_1S6b0tL1MLd6bigCouZed1Md",
                                "tax_rates": []
                            }
                        ],
                        "has_more": False,
                        "total_count": 1,
                        "url": "/v1/subscription_items?subscription=sub_1S6b0tL1MLd6bigCouZed1Md"
                    },
                    "latest_invoice": "in_1SSi5nL1MLd6bigCXplNph9o",
                    "livemode": True,
                    "metadata": {
                        "campaign_code": "F000",
                        "created_by": "FormAssembly - Stripe - Reference: Form 5120065 / Conn. 762535 / Resp. 386321767"
                    },
                    "next_pending_invoice_item_invoice": None,
                    "on_behalf_of": None,
                    "pause_collection": None,
...
@pytest.fixture
def subscription_event_with_honoree_name():
    return {
    "id": "evt_1Spg7XL1MLd6bigCejqap7wS",
    "object": "event",
    "api_version": "2022-11-15",
    "created": 1768443431,
    "data": {
        "object": {
            "id": "sub_1Spg7VL1MLd6bigCVs56WfSQ",
            "object": "subscription",
            "application": "ca_EEtbhRJHFK2etIhjyxcqXqBw3Ck05bKK",
            "application_fee_percent": None,
            "automatic_tax": {
            ...
            "billing_cycle_anchor": 1768443429,
            "billing_cycle_anchor_config": None,
            "billing_mode": {
                "flexible": None,
                "type": "classic"
            ...
            "created": 1768443429,
            "currency": "usd",
            "current_period_end": 1771121829,
            "current_period_start": 1768443429,
            "customer": "cus_TnGebqoEQHrpIh",
            "customer_account": None,
            "days_until_due": None,
            "default_payment_method": "pm_1Spg7UL1MLd6bigCqaJlkpSl",
            "default_source": None,
            "default_tax_rates": [],
            "description": None,
            "discount": None,
                ...
                "data": [
                    {
                        ...
                        "quantity": 354,
                        "subscription": "sub_1Spg7VL1MLd6bigCVs56WfSQ",
                        "tax_rates": []
                    }
                ],
                "has_more": False,
                "total_count": 1,
                "url": "/v1/subscription_items?subscription=sub_1Spg7VL1MLd6bigCVs56WfSQ"
            },
            "latest_invoice": "in_1Spg7VL1MLd6bigCYFD9Vsdj",
            "livemode": False,
            "metadata": {
                "campaign_code": "F000",
                "created_by": "FormAssembly - Stripe Test Connector - Reference: Form 5209061 / Conn. 873218 / Resp. 394119127",
                "honoree_name": "James Thomas Murphy"
            },
            "next_pending_invoice_item_invoice": None,
            "on_behalf_of": None,
            "pause_collection": None,
    ...
    "pending_webhooks": 0,
    "request": {
        "id": "req_msoTPXcvbM5Sfx",
        "idempotency_key": "f071b04d-1db3-4079-80c1-b2c96ea6ff71"
    },
    "type": "customer.subscription.created"
}

@pytest.fixture
def failed_subscription_event_11_8_25():
    return {
    "id": "evt_1SR7BkL1MLd6bigCroc2jyYC",
    "object": "event",
    "api_version": "2022-11-15",
    "created": 1762589279,
    "data": {
        "object": {
            "id": "sub_1SR7BiL1MLd6bigCH52YfpZE",
            "object": "subscription",
            "application": "ca_EEtbpNfCXuyxRLnevQm4k27P4HUXWUWm",
            "application_fee_percent": None,
            "automatic_tax": {
            ...
            "billing_cycle_anchor": 1762589278,
            "billing_cycle_anchor_config": None,
            ...
            "created": 1762589278,
            "currency": "usd",
            "current_period_end": 1765181278,
            "current_period_start": 1762589278,
            "customer": "cus_TNsxY7VBzTW7JX",
            "days_until_due": None,
            "default_payment_method": "pm_1SR7BgL1MLd6bigCeflKXnOv",
            "default_source": None,
            "default_tax_rates": [],
            "description": None,
            "discount": None,
                ...
                "data": [
                    {
                        ...
                        "quantity": 10,
                        "subscription": "sub_1SR7BiL1MLd6bigCH52YfpZE",
                        "tax_rates": [],
                    }
                ],
                "has_more": False,
                "total_count": 1,
                "url": "/v1/subscription_items?subscription=sub_1SR7BiL1MLd6bigCH52YfpZE",
            },
            "latest_invoice": "in_1SR7BiL1MLd6bigCDy9TtnrX",
            "livemode": True,
            "metadata": {
    ...
    "pending_webhooks": 1,
    "request": {
        "id": "req_5tn1it6aoEglMY",
        "idempotency_key": "6b086715-9232-476c-ad2f-369beccc49de",
    },
    "type": "customer.subscription.created",
}
