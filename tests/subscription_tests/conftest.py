...
def subscription_update_event_json():
    return json.dumps(
        {'id': 'evt_1PVm1GL1MLd6bigCoqQjk6zQ', 'object': 'event', 'api_version': '2022-11-15', 'created': 1719370537,
         'data': {'object': {'id': 'sub_1PVm1CL1MLd6bigCoJNJkhJi', 'object': 'subscription',
                             'application': 'ca_EEtbhRJHFK2etIhjyxcqXqBw3Ck05bKK', 'application_fee_percent': None,
                             'automatic_tax': {'enabled': False, 'liability': None}, 'billing_cycle_anchor': 1719370533,
                             'billing_cycle_anchor_config': None, 'billing_thresholds': None, 'cancel_at': None,
                             'cancel_at_period_end': False, 'canceled_at': None,
                             'cancellation_details': {'comment': None, 'feedback': None, 'reason': None},
                             ...
                             'invoice_settings': {'account_tax_ids': None, 'issuer': {'type': 'self'}},
                             'items': {'object': 'list', 'data': [
                                 {'id': 'si_QMV1IuZHIUIeZT', 'object': 'subscription_item', 'billing_thresholds': None,
                                  ...
                                  'subscription': 'sub_1PVm1CL1MLd6bigCoJNJkhJi', 'tax_rates': []}], 'has_more': False,
                                       'total_count': 1,
                 ...
                 'created_by': 'FormAssembly - Stripe - Reference: Form 5120065 / Conn. 762535 / Resp. 343927769'},
                             'next_pending_invoice_item_invoice': None, 'on_behalf_of': None, 'pause_collection': None,
                             'payment_settings': {'payment_method_options': None, 'payment_method_types': None,
                                                  'save_default_payment_method': 'off'},
                             'pending_invoice_item_interval': None, 'pending_setup_intent': None,
                             'pending_update': None,
                             ...
                             'trial_end': None,
                             'trial_settings': {'end_behavior': {'missing_payment_method': 'create_invoice'}},
                             'trial_start': None}, 'previous_attributes': {'status': 'incomplete'}}, 'livemode': False,
         'pending_webhooks': 1,
...
@pytest.fixture
def subscription_create_event_json():
    return json.dumps(
        {'id': 'evt_1PVm1GL1MLd6bigCoqQjk6zQ', 'object': 'event', 'api_version': '2022-11-15', 'created': 1719370537,
         'data': {'object': {'id': 'sub_1PVm1CL1MLd6bigCoJNJkhJi', 'object': 'subscription',
                             'application': 'ca_EEtbhRJHFK2etIhjyxcqXqBw3Ck05bKK', 'application_fee_percent': None,
...
@pytest.fixture
def subscription_delete_event_json():
    return json.dumps(
        {'id': 'evt_1PVm1GL1MLd6bigCoqQjk6zQ', 'object': 'event', 'api_version': '2022-11-15', 'created': 1719370537,
         'data': {'object': {'id': 'sub_1PVm1CL1MLd6bigCoJNJkhJi', 'object': 'subscription',
                             'application': 'ca_EEtbhRJHFK2etIhjyxcqXqBw3Ck05bKK', 'application_fee_percent': None,
