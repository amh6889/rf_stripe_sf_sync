...
@pytest.fixture
def donation_failure_event_11_8_2025():
    return {
    "id": "evt_3Sc0RPL1MLd6bigC17aX0O7U",
    "object": "event",
    "api_version": "2022-11-15",
    "created": 1765184953,
    "data": {
        "object": {
            "id": "ch_3Sc0RPL1MLd6bigC1pXu74Tz",
            "object": "charge",
            "amount": 1000,
            ...
            "application_fee": None,
            "application_fee_amount": None,
            "balance_transaction": "txn_3Sc0RPL1MLd6bigC1AsByMLK",
            "billing_details": {
                "address": {
                    "city": "Kialla",
                    "country": "AU",
                    "line1": "7 Vickers Street",
                    "line2": "7 Vickers Street",
                    "postal_code": "3631",
                    "state": "Victoria",
                },
                "email": None,
                "name": "Hayden Frizzell",
                "phone": None,
                "tax_id": None,
            },
            "calculated_statement_descriptor": "REASONABLE FAITH",
            ...
            "failure_message": None,
            "fraud_details": {},
            "invoice": "in_1SbzUOL1MLd6bigCQWcPw9u6",
            "livemode": True,
            "metadata": {},
            "on_behalf_of": None,
            "order": None,
            ...
            "paid": True,
            "payment_intent": "pi_3Sc0RPL1MLd6bigC1deSobCR",
            "payment_method": "pm_1SR7BgL1MLd6bigCeflKXnOv",
            "payment_method_details": {
                "card": {
                    "amount_authorized": 1000,
                    "authorization_code": "405071",
                    "brand": "visa",
                    "checks": {
                    ...
                    "network_transaction_id": "465342329529151",
                    "overcapture": {
            ...
            "receipt_email": None,
            "receipt_number": None,
            "receipt_url": "https://pay.stripe.com/receipts/invoices/CAcQARoXChVhY2N0XzFLamNVUUwxTUxkNmJpZ0MouavayQYyBghqfGb-3DosFoC8LY-fHo8OSqXzPhT6jmcJgUsrEo5HdOfz3s8DyH7h0rulSe_bUOMp59c?s=ap",
            "refunded": False,
            "review": None,
            "shipping": None,
            "source": None,
    ...
    "request": {
        "id": None,
        "idempotency_key": "in_1SbzUOL1MLd6bigCQWcPw9u6-initial_attempt-1659edc06f59e7d51",
    },
    "type": "charge.succeeded",
}
...
@pytest.fixture
def donation_failure_event_1_31_26():
    return {
    "id": "evt_3SsuObL1MLd6bigC13ehUI5x",
    "object": "event",
    "api_version": "2022-11-15",
    "created": 1769693092,
    "data": {
        "object": {
            "id": "py_3SsuObL1MLd6bigC1kAeaRPi",
            "object": "charge",
            "amount": 42500,
            "amount_captured": 42500,
            "amount_refunded": 0,
            "application": None,
            "application_fee": None,
            "application_fee_amount": None,
            "balance_transaction": "txn_3SsuObL1MLd6bigC1E9FpcP1",
            "billing_details": {
                "address": {
                    "city": "McLean",
                    "country": "US",
                    "line1": "8223 Riding Ridge Place",
                    "line2": None,
                    "postal_code": "22102",
                    "state": "VA",
                },
                "email": "phopkins@datasourceinc.com",
                "name": "Pamela Hopkins",
                "phone": None,
                "tax_id": None,
            },
            ...
            "paid": True,
            "payment_intent": "pi_3SsuObL1MLd6bigC1CF6m7zp",
            "payment_method": "pm_1SsuQUL1MLd6bigCQ8dOWEMM",
            "payment_method_details": {
                ...
                "us_bank_account": {
                    ...
                    "expected_debit_date": "2026-01-26",
                    "fingerprint": "kk7WSlmYadEBkzhv",
                    "last4": "5670",
                    "mandate": "mandate_1SsuQVL1MLd6bigCaBIw7zUv",
                    "payment_reference": "111000021868425",
            ...
            "receipt_email": None,
            "receipt_number": None,
            "receipt_url": "https://pay.stripe.com/receipts/payment/CAcQARoXChVhY2N0XzFLamNVUUwxTUxkNmJpZ0MopL_tywYyBotlBTTejTosFkbEwb3kL3aN3xJJ15gMMgWFEZapvIJln5Fg86AaqPgMRTaF5NxPFcWrTzI",
            "refunded": False,
            "review": None,
            "shipping": None,
            "source": None,
